...
class QR(TDMAB):
    ...
    def update(self, arm, reward):
        ...
        if self._adapt_lr is None:
            ...
            self._learning_rate = epistemic / (epistemic + aleatoric)
        elif self._adapt_lr["type"] == "ratio_2":
            self._learning_rate = epistemic**2 / (epistemic + aleatoric)
