...
class DoyaDaYu(td_mab.TDMAB):
    ...
    def __init__(
        ...
        self._qv_initialisation = qv_initialisation

        self._adapt_temperature = adapt_temperature
        self._adapt_lrate = adapt_lrate
    ...
    def _setup_values(self):
        ...
        if self._qv_initialisation > 0.0:
            self._qv_initialisation = self._rng.normal(
                scale=self._qv_initialisation, size=self._n_arms
            )
